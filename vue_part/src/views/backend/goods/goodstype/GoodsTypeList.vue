<template>
                    ...
                    <el-col :span="8" :offset="0">
                        <el-form-item label="商品名称" >
                            <SelectChecked :options="nameoptions" @change="selected" ref="selectRef"
                                v-model="searchParam.goods_type_name" filterable style="width: 220px;"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8" :offset="0">
                        <el-form-item label="编码">
                            <SelectChecked :options="codeoptions" @change="selected" ref="selectRef"
                                v-model="searchParam.goods_type_encode" filterable style="width: 220px;"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8" :offset="0">
                        <el-form-item label="备注">
                            <el-input v-model="searchParam.goods_type_remark" clearable />
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
    ...
    <div class="table">
        ...
        <el-table ref="tableList" :data="tableData" stripe
            ...
            <el-table-column prop="goods_type_name" label="商品名称" />
            <el-table-column label="编码">
                <template #default="scope">
                    {{ scope.row.goods_type_encode ? scope.row.goods_type_encode : "--" }}
                </template>
            </el-table-column>
            <el-table-column label="备注">
                <template #default="scope">
                    {{ scope.row.goods_type_remark ? scope.row.goods_type_remark : "--" }}
                </template>
            </el-table-column>
            <el-table-column label="操作" min-width="180" width="220" align="center">
                <template #default="scope">
                    ...
                    <el-button link type="primary" size="small" @click="deleteBtn(scope.row.goods_type_id)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
            ...
            <el-form ref="addRef" label-width="auto" :model="addModel" :inline="true" :rules="rules">
                <el-row>
                    <el-col :span="12" :offset="0">
                        <el-form-item label="标题" prop="goods_type_name">
                            <el-input v-model="addModel.goods_type_name" clearable/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12" :offset="0">
                        <el-form-item label="编码" prop="goods_type_encode">
                            <el-input v-model="addModel.goods_type_encode" clearable/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12" :offset="0">
                        <el-form-item label="备注" prop="goods_type_remark">
                            <el-input v-model="addModel.goods_type_remark" clearable/>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
...
import { addApi, getListApi, editApi, deleteApi, allDeleteApi,uploadApi,getCodeSelectApi,getNameSelectApi} from '@/api/backend/Goods/GoodsType/index'
...
const resetBtn = () => {
    ...
    searchParam.goods_type_encode = '';
    searchParam.goods_type_name= '';
    searchParam.goods_type_remark= '';
    getList();
}
...
const allDeleteBtn = async () => {
    ...
    ElMessageBox.confirm(
        ...
        .then(async () => {//点击确定
            const ids = multipleSelection.value.map((item: { goods_type_id: any; }) => item.goods_type_id);
            console.log(ids);
